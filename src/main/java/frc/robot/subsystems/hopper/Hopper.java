...
public class Hopper extends SubsystemBase {
    ...
    private Command intake() {
        return this.run(
                () -> this.feedWheels.set(TalonSRXControlMode.PercentOutput, HopperConstants.INTAKE_DUTY_CYCLE));
    }
    ...
    private Command agitate() {
        return this.run(
                () -> this.feedWheels.set(TalonSRXControlMode.PercentOutput, HopperConstants.AGITATION_DUTY_CYCLE));
    }
